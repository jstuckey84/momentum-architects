  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-md border-b border-border">
      <div className="max-w-6xl mx-auto flex items-center justify-between px-6 py-4">
        <a href="#" className="text-foreground font-bold tracking-tight text-lg">
          CLARITY OPS
        </a>
        ...
        <div className="hidden md:flex items-center gap-8 text-sm text-muted-foreground">
          ...
          <a
            href="mailto:hello@clarityops.com"
      ...
      {open && (
        <div className="md:hidden border-t border-border px-6 py-4 flex flex-col gap-4 bg-background">
          ...
          <a href="mailto:hello@clarityops.com" className="bg-primary text-primary-foreground px-5 py-2 rounded-sm font-semibold tracking-wide text-xs uppercase text-center">
            Get in Touch
          </a>
        </div>
      )}
